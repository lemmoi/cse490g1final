...
Out of the 1.6 million molecules, 4 were unable to successfully converge to 3D structures.
...
Finally, the individual CSV files were rejoined back together as a csv file for each of the training,
